...
\033[1;94mFACEBOOK USERNAME : @Tera.Deewana28
                  
\033[1;92mFB PROFILE NAME          :  ARAFAT X 69
...
║ OWNER     ║       ARAFAT X 69         ║
║ PARTNER   ║       SOHEL X 69          ║
║ FACEBOOK  ║       @Tera.Deewana28     ║
║ STATUS    ║       FREE                ║ 
║ VERSION   ║       1.0                 ║ 
║ NOTE      ║    LOGIN AFTER 5 DAYS     ║
╚══───────╝───────────────────────╝
...
""")
CorrectUsername = "OLD ID"
CorrectPassword = "Te4m X 69"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-https://wa.me/+8801983268976')
    else:
...
\033[1;95mFb\033[1;97mTe4m X 69"""
